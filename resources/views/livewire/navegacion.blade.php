<nav class="z-50 fixed top-0 bg-white shadow-md w-full" x-data="{ open:false }">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-16">

            <!-- Mobile menu button-->
            <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                <button x-on:click="open = true" type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                    <span x-show="open = false" class="sr-only">Open main menu</span>
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        ...
                        <a href="" class="text-blue-800 hover:bg-blue-800 hover:text-white px-3 py-2 rounded-md text-base font-semibold">Nuestra empresa</a>
                ...
                <div class="ml-3 relative" x-data="{ open:false }">
                    <div>
                        <button x-on:click="open = true" type="button" class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                            <span x-show="false" class="sr-only">Open user menu</span>
                    ...
                    <div x-show="open" x-on:click.away="open = false" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                        ...
                        {{-- Can se encarga de verificar si el user tiene o no el permiso --}}
                        @can('admin.home')
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            this.closest('form').submit();">Cerrar Cesión</a>
                        </form>
                    </div>
                </div>
            </div>
            ...
            @else
                ...
                <div>
                    <a href="{{route('login')}}" class="text-blue-800 hover:bg-blue-800 hover:text-white px-3 py-2 rounded-md text-base font-semibold">Iniciar Cesión</a>
                    <a href="{{route('register')}}" class="text-blue-800 hover:bg-blue-800 hover:text-white px-3 py-2 rounded-md text-base font-semibold">Registrarse</a>
                </div>
